<?php
	...
	class manageContent_DAL
	{
		...
		*/
		...
		- auth: Dipanjan
		*/
		function insertProduct($product_id,$category,$product_name,$description,$old_price,$price_guest,$price_members,$discount,$stock,$date,$expiration_date,$maxpick,$status,$image,$image1,$image2,$image3,$image4)
		{
			$query = $this->link->prepare("INSERT INTO `product_table`(`product_id`, `category`, `product_name`, `product_description`, `old_price`, `price_guest`, `price_members`, `discount`, `stock`, `date`, `expiration_date`, `maxpick`, `status`, `image`, `image1`, `image2`, `image3`, `image4`)
VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			$values = array($product_id,$category,$product_name,$description,$old_price,$price_guest,$price_members,$discount,$stock,$date,$expiration_date,$maxpick,$status,$image,$image1,$image2,$image3,$image4);
			$query->execute($values);
			return $query->rowCount();
		}
		...
		- auth: Dipanjan
		*/
		function insertCoupon($coupon_id,$category,$coupon_name,$description,$coupon_code,$old_price,$price_guest,$price_members,$discount,$stock,$date,$expiration_date,$maxpick,$status,$image)
		{
			$query = $this->link->prepare("INSERT INTO `coupon_table`(`coupon_id`, `category`, `coupon_name`, `coupon_description`, `coupon_code`, `old_price`, `price_guest`, `price_members`, `discount`, `stock`, `date`, `expiration_date`, `maxpick`, `status`, `image`)
VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			$values = array($coupon_id,$category,$coupon_name,$description,$coupon_code,$old_price,$price_guest,$price_members,$discount,$stock,$date,$expiration_date,$maxpick,$status,$image);
			$query->execute($values);
			return $query->rowCount();
		}
